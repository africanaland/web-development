                ...
                <ul class="header-dropdown">
                    <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="zmdi zmdi-more"></i> </a>
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li><a href="{{ route('commission.create') }}">Create</a></li>                            
                        </ul>
                    </li>
                </ul>
            </div>
                        ...
                        <table class="table table-bordered table-striped js-basic-example dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{-- <a title="View" href="{{ route('commission.show',$aRow->id) }}"><i class="material-icons">remove_red_eye</i></a> --}}
                                        <a href="{{ route('commission.edit',$aRow->id) }}"><i class="material-icons">edit</i></a>
                                        ...
                                        action="{{ route('commission.destroy',$aRow->id) }}" method="post" style="display: none;">
                                           {{ method_field('DELETE') }}
                                           {{ csrf_field() }}
