                    ...
                    <tbody>
                        ...
                        <tr><th>Ratings</th>
                            <td>
                                <div class="row">
                                    <div class="col-sm-4">
                                        <h6 class="m-0 p-0">Average Rating</h6>
                                        <div class="ratings">
                                    ...
                                    <div class="col-sm-8">
                                        <h6 class="m-0 p-0">Total Rating</h6>
                                        <div class="d-flex">
                                            @forelse ($review as $item)
                                                <span class="pr-3">
                                                    @for ($i = 0; $i < $item->star; $i++)
                                                        <i class="text-gold zmdi zmdi-star"></i>
                                                    @endfor
                                                    {{$item->count}}
                                                </span>
                                            @empty
                        ...
                        <tr><th>Policy</th><td><div class="cke_wrapper" style="width:40%">{!!html_entity_decode($aRow->policy)!!} </div></td></tr>
                           ...
                           <td> 
                               @if($aImages)
                                <div class="d-flex mt-3">
                                    ...
                                    <span class="mb-2">
                                        <img src="{{  App\Helpers\CustomHelper::displayImage($aImage) }}" class="rounded" >
                                    </span>
                                    @endforeach
                                </div>
                                @endif
