<html style="width:100%;font-family: 'Poppins', sans-serif !important;text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0;">
...
<body style="margin: 0px; background-color: #f5f5f5; color: #605c5b">
          ...
          <tbody>
            <td align="center" style=" margin:0px;padding-bottom:30px;padding-left:30px;padding-right:30px;padding-top:35px;">
              ...
              <p style="margin:0px;  font-size:18px;font-family: 'Poppins', sans-serif !important;line-height:27px;">Your
                booking has been confirmed successfully.</p>
              <p style="font-size: 18px;margin:0;line-height:58px;mso-line-height-rule:exactly;font-family: 'Poppins', sans-serif !important;font-style:normal;font-weight:normal;color:#464646;">
  ...
  <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
    <tbody>
                ...
                <td align="left" valign="top" style="margin:0;">
                  ...
                  <table width="100%">
                    <tbody>
                      <tr>
                        <td>
                          <p style="font-family: 'Poppins', sans-serif !important;margin-bottom: 0px;  text-align: left; color:#da8961;font-size:24px; border-bottom: 1px solid #bababa;">
                            {{$propertyName}}</p>
                      ...
                      <tr>
                        ...
                        <td>
                          <p style="font-family: 'Poppins', sans-serif !important; margin: 3px; border-bottom: 1px solid #bababa;"> {{$address}} </p>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <p style="font-family: 'Poppins', sans-serif !important;color:#da8961; margin: 3px;">Check in :<span style="color: #000000;">
                              {{$checkin}}</span></p>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <p style="font-family: 'Poppins', sans-serif !important;color:#da8961; margin: 3px; border-bottom: 1px solid #bababa;">Check out :<span style="color: #000000;"> {{$checkout}}</span></p>
                        </td>
                      </tr>
                    </tbody>
                  </table>
                    ...
                    <tbody>
                      <tr>
                        <td>
                          ...
                          <p style="font-family: 'Poppins', sans-serif !important;color:#da8961; margin: 3px; float: left;">Adult :<span style="color: #000000;">
                              NAN</span></p>

                        </td>

                        <td>
                          <p style="font-family: 'Poppins', sans-serif !important;color:#da8961; margin: 3px; float: right;">Children :<span style="color: #000000;">
                              NAN</span></p>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <p style="font-family: 'Poppins', sans-serif !important;color:#da8961; margin: 3px; float: left;">Rooms :<span style="color: #000000;">
                              NAN</span></p>
                        </td>
                        <td>
                          <p style="font-family: 'Poppins', sans-serif !important;color:#da8961; margin: 3px; float: right; ">Type :<span style="color: #000000;">
                              NAN</span></p>
                        </td>
                      </tr>
                    </tbody>
                  ...
                  <table style="width: 90%;  border-top: 1px solid #bababa;">
                    <tbody>
                      <tr>
                        <td>
                          <p style="font-family: 'Poppins', sans-serif !important;color:#da8961; margin: 3px; float: left;">Additional Services </p>
                        </td>
                      </tr>
          ...
          <table style=" max-width: 792px;width: 100%;margin: auto;background: #fff; box-shadow: 0px 5px 10px -2px ;">
            <tbody>
              <td align="center" style="margin:0;padding-bottom:25px;padding-left:30px;padding-right:30px;padding-top:25px;  ">
                <p style="font-size: 24px;"><span style="color: #da8961 !important;border-bottom: 1px solid #da8961 !important;font-family: 'Poppins', sans-serif !important;padding-bottom: 9px;">Total Price :{{$price}}$</span>
                </p>
      ...
      <tr style="border-collapse:collapse;">
        <td style="padding:0;margin:0; ">
          <table style="background-color: #ececec; max-width: 792px;width: 100%;margin: auto; box-shadow: 0px 5px 10px -2px ;">
            <tbody>
              <td align="center" style="margin:0;padding-bottom:25px;padding-left:30px;padding-right:30px;padding-top:25px;  ">
                <p style=""><span style="    font-size: 16px; font-family: 'Poppins', sans-serif !important;">You can view your booking and edit
                    detail by visiting </span></p>
                    <a href="{{ $url }}" style="padding: 10px;background: #da8961;width: 151px;font-family: 'Poppins', sans-serif !important; border-radius: 6px; color: #ffffff;text-decoration:none">Bookings</a>
              </td>
            </tbody>
          </table>
        </td>
      ...
      <tr style="border-collapse:collapse;">
        <td style="padding:0;margin:0; ">
          <table style="border-bottom-left-radius: 8px;border-bottom-right-radius: 8px;border-top: 1px solid #bababa; max-width: 792px;width: 100%;margin: auto;background: #fff; box-shadow: 0px 5px 10px -2px ;">
            <tbody>
              <td align="center" style="margin:0;padding-bottom:25px;padding-left:30px;padding-right:30px;padding-top:25px;">
