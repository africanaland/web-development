<html style="width:100%;font-family: 'Poppins', sans-serif !important;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0;"><head> 
  <meta charset="UTF-8"> 
         ...
         <tr style="border-collapse:collapse;"> 
            <td  style="padding:0;margin:0px; "> 
              <table style="max-width: 792px;width: 100%;margin: auto;background: #fff;  box-shadow: 0px 5px 10px -2px ;border-top-left-radius: 8px;border-top-right-radius: 8px;">
                <tbody>
                  <td align="center" style=" margin:0px;padding-bottom:30px;padding-left:30px;padding-right:30px;padding-top:35px;"> <p style="margin:0;line-height:58px;mso-line-height-rule:exactly;font-family: 'Poppins', sans-serif !important;font-size:38px;font-style:normal;font-weight:normal;color:#464646;">Dear <span style="color:#da8961;">{{ $name }}, </span></p>
                       <p style="margin:0px;  font-size:18px;font-family: 'Poppins', sans-serif !important;line-height:27px;color:#777777">Credit Card has been Removed successfully.</p> 
                  </td>
                </tbody>
              </table>
            </td> 
            ...
            <table style="max-width: 792px;width: 100%;margin: auto;background: #fff; box-shadow: 0px 5px 10px -2px ;">
              <tbody>
                <td align="center" style="margin:0;padding-bottom:5px;padding-left:30px;padding-right:30px;"> 
                    ...
                    <img src="http://africanaland.com/public/images/MailCard.png" style="width: 180px; margin: 15px; margin-top:0px; ">


                     <p><span style="font-family: 'Poppins', sans-serif !important;;font-size:19px;;padding-bottom: 10px;">XXXX XXXX XXXX {{ $cardNo }} </span></p>

                      <hr style="width:60%;margin:auto;border:0.5px solid #e19e7d">

                    <p style="    font-family: 'Poppins', sans-serif !important;font-size: 24px;color: #464646;margin-top: 0.5em;padding-bottom: 5px;">Thanks</p>
                </td>
              </tbody>
            </table>
          </td> 
