         ...
         <tr style="border-collapse:collapse;"> 
            <td  style="padding:0;margin:0px; "> 
              <table style="max-width: 792px;width: 100%;margin: auto;background: #fff;  box-shadow: 0px 5px 10px -2px ;border-top-left-radius: 8px;border-top-right-radius: 8px;">
                <tbody>
                  <td align="center" style=" margin:0px;padding-bottom:30px;padding-left:30px;padding-right:30px;padding-top:35px;"> <p class="nameField">Dear <span style="color:#da8961;">{{ $name }}, </span></p>
                       <p style="margin:0px;font-family: 'Poppins', sans-serif !important;  font-size:18px;line-height:27px;">Credit Card has been Add successfully</p> 
                  </td>
                </tbody>
              </table>
            </td> 
              ...
              <tbody>
                <td align="center" style="margin:0;padding-bottom:5px;padding-left:30px;padding-right:30px;"> 
                    ...
                    <img src="http://africanaland.com/public/images/MailCard.png" style="width: 180px; margin: 15px; margin-top:0px; ">
                     ...
                     <p><span style="color:#da8961;font-size:24px;font-family: 'Poppins', sans-serif !important; border-bottom: 1px solid #e19e7d;padding-bottom: 10px;">XXXX XXXX XXXX {{ $cardNo }} </span></p>

                    <p style="font-size:24px;font-family: 'Poppins', sans-serif !important; color: #464646;">Thanks</p>
                </td>
              </tbody>
            </table>
          </td> 
