              ...
              <table style="max-width: 792px;width: 100%;margin: auto;background: #fff;  box-shadow: 0px 5px 10px -2px ;border-top-left-radius: 8px;border-top-right-radius: 8px;">
                <tbody>
                  <td align="center" style=" margin:0px;padding-bottom:30px;padding-left:30px;padding-right:30px;padding-top:35px;"> 
                        <p style="margin:0;line-height:58px;mso-line-height-rule:exactly;font-family: 'Poppins', sans-serif !important;font-size:38px;font-style:normal;font-weight:normal;color:#464646;">Dear <span style="color:#da8961;">{{ $name }}, </span></p>
                       <p style="margin:0px;  font-size:18px; font-family: 'Poppins', sans-serif !important;color:#777777; ">Your Booking has been Canceled Successfully </p>
                       <h3 srtle="margin:0px;  font-size:17px; font-family: 'Poppins', sans-serif !important;color:#777777; "> Booking ID {{ $bookingId}}</h3>
                  </td>
                </tbody>
              </table>
            </td>
            ...
            <table style="max-width: 792px;width: 100%;margin: auto;background: #fff; box-shadow: 0px 5px 10px -2px ;">
              <tbody>
                <td align="center" style="margin:0;padding-bottom:5px;padding-left:30px;padding-right:30px;">
                    ...
                    <img src="http://africanaland.com/public/images/img_4.png" style="width: 180px; margin: 15px; margin-top:0px; ">

                    <p style="font-size:24px; color: #464646;font-family: 'Poppins', sans-serif !important;">Thanks</p>
                </td>
              </tbody>
            </table>
          </td>
