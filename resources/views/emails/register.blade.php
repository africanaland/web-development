<html style="width:100%;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0;"><head> 
  <meta charset="UTF-8"> 
         ...
         <tr style="border-collapse:collapse;"> 
            <td  style="padding:0;margin:0px; "> 
              <table style="max-width: 792px;width: 100%;margin: auto;background: #fff;  box-shadow: 0px 5px 10px -2px ;border-top-left-radius: 8px;border-top-right-radius: 8px;">
                <tbody>
                  <td align="center" style=" margin:0px;padding-bottom:30px;padding-left:30px;padding-right:30px;padding-top:35px;"> <p style="margin:0; margin-bottom: 5px; line-height:58px;mso-line-height-rule:exactly;font-family:BioRhyme, serif, sans-serif;font-size:38px;font-style:normal;font-weight:normal;color:#464646;font-family: 'Poppins', sans-serif !important;">Hi <span style="color:#da8961;">{{ $name }}, </span></p>
                       <p style="margin:0px;  font-size:32px;font-family:BioRhyme, serif, sans-serif;line-height:27px;font-family: 'Poppins', sans-serif !important;">Welcome To African Land.</p> 
                       <p style="margin:0;line-height:58px;mso-line-height-rule:exactly;font-family:BioRhyme, serif, sans-serif;font-style:normal;font-weight:normal;color:#464646;"></p>
                  </td>
                </tbody>
              </table>
            </td> 
       ...
       <tr style="border-collapse:collapse;"> 
          <td  style="padding:0;margin:0; "> 
            <table style="max-width: 792px;width: 100%;margin: auto;background: #fff; box-shadow: 0px 5px 10px -2px ;">
              <tbody>
                <td align="center" style="margin:0;padding-bottom:5px;padding-left:30px;padding-right:30px;"> 
                 
                    <img src="http://africanaland.com/public/images/img_7.png" style="width: 180px; margin: 15px; margin-top:0px; ">
        ...
        <tr style="border-collapse:collapse;"> 
          <td  style="padding:0;margin:0; "> 
            <table  style=" max-width: 792px;width: 100%;margin: auto;background: #fff; box-shadow: 0px 5px 10px -2px ;">
              <tbody  >
                <td align="center" style="margin:0;padding-bottom:25px;padding-left:30px;padding-right:30px;padding-top:25px;  "> <p><span style=" font-family: 'Poppins', sans-serif !important; ">your account has been approved  and  you can now <br> login to Africana Land </span></p>
                  <p style="font-size: 20px;border-top: 1px solid  #da8961;display: inline-block;width: 50%;
                  padding-top: 12px;margin-top: 11px;"><span style="font-family: 'Poppins', sans-serif !important;">Thanks For Registration</span></p>
                </td> 
              </tbody>
            </table>
          </td> 
        ...
        <tr style="border-collapse:collapse;"> 
          <td  style="padding:0;margin:0; "> 
            <table  style="background-color: #e2e2e2; max-width: 792px;width: 100%;margin: auto; box-shadow: 0px 5px 10px -2px ;">
              <tbody  >
                <td align="center" style="margin:0;padding-bottom:25px;padding-left:30px;font-family: 'Poppins', sans-serif !important;padding-right:30px;padding-top:25px;  "> <p style=""><span style=" ">You can access your account on any device </span></p>
                  <a href="{{ $url }}" style="padding: 10px;background: #da8961;width: 151px;font-family: 'Poppins', sans-serif !important; border-radius: 6px; color: #ffffff;text-decoration:none">Get Started</a>
                </td> 
              </tbody>
            </table>
          </td> 
