...
<div class="modal-header border-bottom">
    <h5 class="modal-title text-left" id="exampleModalLabel">Booking Summary</h5>
...
<div class="row border-bottom py-4 px-2 justify-content-center">
<div class="col-md-12">
        <b>{{ $aRow->name }}</b> <br>
...
<div class="row border-bottom py-4 px-2 justify-content-center ">
    ...
    <div class="row border-bottom py-4 px-3 justify-content-center">
        ...
        <div class="col-md-6">
            <div class="form-group">                                
                <div class="input-group mb-3">                                          
                    <input type="text" autocomplete="false" readonly class="border-right-0 form-control" id="" placeholder="Per Night" style="background: #fff">
                    <div class="input-group-append">
                     <span class="input-group-text border-left-0" style="color: #dc8b64">{{ $aRow->daily_rate }} $</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">                                
                <div class="input-group mb-3">                                          
                    ...
                    <div class="input-group-append">
                     <span class="input-group-text border-left-0" style="color: #dc8b64">{{ $total_amount }} $</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row py-4 px-3 justify-content-center">
        <div class="d-flex">
            <input type="button" class="btn btn-lg btn-afland mr-3" name="" value="Continue" onclick="openPopup('{{ route("bookingpayment")}}','frmBookingSummary');">
        </div>
    </div>
    </form>
</div>
